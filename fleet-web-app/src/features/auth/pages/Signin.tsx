...
export default function Signin() {
  ...
  const onSubmit = async (data: SignInForm) => {
    if (isForgotMode) {
      ...
      try {
        ...
        toast.success(
          "If the email exists, a new password has been sent to your inbox.",
        );
  ...
  const isLoading = isForgotMode ? isForgotLoading : loading;
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-100 via-blue-50/80 to-cyan-100/70 flex items-center justify-center p-4">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-20 right-16 h-56 w-56 rounded-full bg-cyan-200/60 blur-3xl"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-20 left-10 h-56 w-56 rounded-full bg-blue-200/60 blur-3xl"
      />
